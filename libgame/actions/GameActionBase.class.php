...
abstract class GameActionBase extends GameBase implements IAction {
	...
	//要减少体力值的操作
	private $action_reduce_strength = array(
				//动物要减少体力的操作
				ActionCode::ACTION_CLEAN_ANIMAL_BODY,
				ActionCode::ACTION_FEED_ANIMAL,
				ActionCode::ACTION_INJECTION,
				ActionCode::ACTION_TOUCH,
				ActionCode::ACTION_LOOKAFTERANIMAL,
				//植物要减少体力的操作
				ActionCode::ACTION_FERTILIZE,
				ActionCode::ACTION_KILL_BAD,
				ActionCode::ACTION_WATER,
				ActionCode::ACTION_SEED,
				ActionCode::ACTION_ADD,
				ActionCode::ACTION_HOE,
				ActionCode::ACTION_HARVEST_TREE,
				ActionCode::ACTION_FERTILIZE_TREE,
				ActionCode::ACTION_CUT_TREE,
				//动物植物共有的操作
//				ActionCode::ACTION_FRIEND_STEAL,
				ActionCode::ACTION_HARVEST,
				//整个游戏的操作
				ActionCode::ACTION_CLEAN_RANCH,
//				ActionCode::ACTION_FEED_DOG,
				ActionCode::ACTION_CREATE_BUILDING,
				ActionCode::ACTION_ITEM_LIB_HARVEST,
				ActionCode::ACTION_HIT_MONKEY,
				ActionCode::ACTION_HIT_BIG_MONSTER_NIAN,
				ActionCode::ACTION_CLEAN_RUB);
	//要记录动作数量的操作
	private $action_record_count = array(
				//整个游戏
				ActionCode::ACTION_COMPLETE_TASK,
				ActionCode::ACTION_HELP_FRIENDS,
				ActionCode::ACTION_SEND_GIFT,
				//动物
				ActionCode::ACTION_FEED_ANIMAL,
				ActionCode::ACTION_INJECTION,
				ActionCode::ACTION_TOUCH,
				...
				ActionCode::ACTION_HARVEST,
				//机器动作
				ActionCode::ACTION_HARVEST_CROPBYVEHICLE,
				ActionCode::ACTION_PLANT_CROPBYVEHICLE,
				ActionCode::ACTION_PLOW_CROPBYVEHICLE,
				ActionCode::ACTION_PROCESS,
				ActionCode::ACTION_CLEAN_PET,
				ActionCode::ACTION_USE_ROOM,
				ActionCode::ACTION_PROCESS_IN_FACTORY,
				//收获鱼
				ActionCode::ACTION_FISH_END
				//喂食鸽子次数
//				ActionCode::ACTION_FEED_PIGEON,
//				//完成xx个订单
//				ActionCode::ACTION_FINISH_RANDOM_MISSION
				);
	/**
	 * 日志操作对象
	 *
...
//			}
			...
			// 农场上相关的错误处理
			if ($e->getCode()==GameStatusCode::ACTION_MAX_ALLOWED){
	...
	protected function checkSignature($params){
		// 签名的key必须不为空
		if(empty($params['k'])){
			$this->throwException('signature error',GameStatusCode::GAME_KEY_ERROR);
		}
